...
#SBATCH --output=/cluster/home/angstd/orcAI/20250428_orcai/orcai-v1-3750-LSTM_1/logs/training_output_%j.log
#SBATCH --tmp=120G
...
parameter_file="$output_dir/orcai_parameter_LSTM_init.json"
