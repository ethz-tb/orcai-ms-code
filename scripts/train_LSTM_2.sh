#!/usr/bin/bash
#SBATCH --job-name=orcai-v1-3750-LSTM_2
#SBATCH --output=/cluster/home/angstd/orcAI/20250627_orcai/orcai-v1-3750-LSTM_2/logs/training_output_%j.log
#SBATCH --tmp=120G
...
parameter_file="$output_dir/orcai_parameter_LSTM_init_2.json"
...
model_dir="$output_dir/orcai-v1-3750-LSTM_2"
