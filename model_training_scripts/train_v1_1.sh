#!/usr/bin/bash
#SBATCH --job-name=orcai-v1_1
#SBATCH --output=/cluster/home/angstd/orcAI/orcai-v1_1/logs/training_output_%j.log
#SBATCH --tmp=120G
...
parameter_file="$output_dir/orcai_parameter_v1_1.json"
...
model_dir="$output_dir/orcai-v1_1"
