#!/usr/bin/bash
#SBATCH --job-name=1DC_1
#SBATCH --output=/cluster/home/angstd/orcAI/orcai-v1-3750-1DC_1/logs/training_output.log
#SBATCH --tmp=120G
...
parameter_file="$output_dir/orcai_parameter_1DC_init_1.json"
