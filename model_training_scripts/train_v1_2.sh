#!/usr/bin/bash
#SBATCH --job-name=orcai-v1_2
#SBATCH --output=/cluster/home/angstd/orcAI/orcai-v1_2/logs/training_output_%j.log
#SBATCH --tmp=120G
...
parameter_file="$output_dir/orcai_parameter_v1_2.json"
...
model_dir="$output_dir/orcai-v1_2"
